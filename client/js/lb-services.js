  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Poll.questions.findById() instead.
        "prototype$__findById__questions": {
          params: {
          'fk': '@fk'
          },
          url: urlBase + "/Polls/:id/questions/:fk",
          method: "GET"
        },

        // INTERNAL. Use Poll.questions.destroyById() instead.
        ...
        // INTERNAL. Use Poll.questions.updateById() instead.
        ...
        // INTERNAL. Use Poll.person() instead.
        "prototype$__get__person": {
          url: urlBase + "/Polls/:id/person",
          method: "GET"
        },

        // INTERNAL. Use Poll.questions() instead.
        "prototype$__get__questions": {
          isArray: true,
          url: urlBase + "/Polls/:id/questions",
          method: "GET"
        },

        // INTERNAL. Use Poll.questions.create() instead.
        "prototype$__create__questions": {
          url: urlBase + "/Polls/:id/questions",
          method: "POST"
        },

        // INTERNAL. Use Poll.questions.destroyAll() instead.
        "prototype$__delete__questions": {
          url: urlBase + "/Polls/:id/questions",
          method: "DELETE"
        },

        // INTERNAL. Use Poll.questions.count() instead.
        "prototype$__count__questions": {
          url: urlBase + "/Polls/:id/questions/count",
          method: "GET"
        },
        ...
        // INTERNAL. Use Question.poll() instead.
        "::get::Question::poll": {
    ...
    */
    ...
    /**
     * @ngdoc object
     * @name lbServices.Poll.questions
     * @header lbServices.Poll.questions
     * @object
     * @description
     *
     * The object `Poll.questions` groups methods
     * manipulating `Question` instances related to `Poll`.
     *
     * Call {@link lbServices.Poll#questions Poll.questions()}
     ...
     */
        ...
        R.questions = function() {
          ...
          var action = TargetResource["::get::Poll::questions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Poll.questions#count
         * @methodOf lbServices.Poll.questions
         *
         * @description
         *
         * Counts questions of Poll.
         *
         * @param {Object=} parameters Request parameters.
         *
         *  - `id` – `{*}` - PersistedModel id
        ...
        R.questions.count = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::count::Poll::questions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Poll.questions#create
         * @methodOf lbServices.Poll.questions
         *
         * @description
         *
        ...
        R.questions.create = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::create::Poll::questions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Poll.questions#createMany
         * @methodOf lbServices.Poll.questions
         *
         * @description
         *
        ...
        R.questions.createMany = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::createMany::Poll::questions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Poll.questions#destroyAll
         * @methodOf lbServices.Poll.questions
         *
         * @description
         *
        ...
        R.questions.destroyAll = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::delete::Poll::questions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Poll.questions#destroyById
         * @methodOf lbServices.Poll.questions
         *
         * @description
         *
        ...
        R.questions.destroyById = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::destroyById::Poll::questions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Poll.questions#findById
         * @methodOf lbServices.Poll.questions
         *
         * @description
         *
        ...
        R.questions.findById = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::findById::Poll::questions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Poll.questions#updateById
         * @methodOf lbServices.Poll.questions
         *
         * @description
         *
        ...
        R.questions.updateById = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::updateById::Poll::questions"];
          return action.apply(R, arguments);
        };

        /**
         * @ngdoc method
         * @name lbServices.Poll#person
         * @methodOf lbServices.Poll
         *
         * @description
         *
        ...
        R.person = function() {
          ...
          var action = TargetResource["::get::Poll::person"];
          return action.apply(R, arguments);
        };
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        // INTERNAL. Use Poll.questions.createMany() instead.
        "::createMany::Poll::questions": {
          isArray: true,
          url: urlBase + "/Polls/:id/questions",
          method: "POST"
        },
        ...
        // INTERNAL. Use Poll.questions.count() instead.
        "::count::Poll::questions": {
          url: urlBase + "/Polls/:id/questions/count",
          method: "GET"
        },

        // INTERNAL. Use Responses.question() instead.
        "::get::Responses::question": {
          url: urlBase + "/Responses/:id/question",
          method: "GET"
        },

        // INTERNAL. Use Choices.question() instead.
        "::get::Choices::question": {
    ...
    */
    R.modelName = "Question";
        ...
        R.poll = function() {
          ...
          var action = TargetResource["::get::Question::poll"];
          return action.apply(R, arguments);
        };
    /**
     * @ngdoc object
     ...
     * manipulating `Responses` instances related to `Question`.
     *
     ...
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Responses` object.)
         * </em>
         */
        R.responses = function() {
          var TargetResource = $injector.get("Responses");
     ...
     * manipulating `Choices` instances related to `Question`.
     *
     ...
     */
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `Choices` object.)
         * </em>
         */
        R.choices = function() {
          var TargetResource = $injector.get("Choices");
...
/**
 * @ngdoc object
 * @name lbServices.Responses
 * @header lbServices.Responses
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Responses` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#create
         * @methodOf lbServices.Responses
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#createMany
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#upsert
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#exists
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#findById
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#find
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#findOne
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#updateAll
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#deleteById
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#count
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#prototype$updateAttributes
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#createChangeStream
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#updateOrCreate
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#update
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#destroyById
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Responses#removeById
         * @methodOf lbServices.Responses
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Responses#modelName
    * @propertyOf lbServices.Responses
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Responses`.
    */
    R.modelName = "Responses";


        /**
         * @ngdoc method
         * @name lbServices.Responses#question
         * @methodOf lbServices.Responses
         *
         * @description
         *
        ...
        R.question = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::get::Responses::question"];
          return action.apply(R, arguments);
        };
...
/**
 * @ngdoc object
 * @name lbServices.Choices
 * @header lbServices.Choices
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `Choices` model.
 *
 * ## Example
 *
 * See
  ...
  ['LoopBackResource', 'LoopBackAuth', '$injector', function(Resource, LoopBackAuth, $injector) {
    var R = Resource(
      ...
      { 'id': '@id' },
      {
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#create
         * @methodOf lbServices.Choices
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source.
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#createMany
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#upsert
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#exists
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#findById
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#findOne
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#updateAll
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#deleteById
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#prototype$updateAttributes
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#createChangeStream
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#updateOrCreate
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#update
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#destroyById
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#removeById
         * @methodOf lbServices.Choices
         *
         * @description
         *
    ...
    /**
    * @ngdoc property
    * @name lbServices.Choices#modelName
    * @propertyOf lbServices.Choices
    * @description
    * The name of the model represented by this $resource,
    * i.e. `Choices`.
    */
    R.modelName = "Choices";
        ...
        /**
         * @ngdoc method
         * @name lbServices.Choices#question
         * @methodOf lbServices.Choices
         *
         * @description
         *
        ...
        R.question = function() {
          var TargetResource = $injector.get("Question");
          var action = TargetResource["::get::Choices::question"];
          return action.apply(R, arguments);
        };
